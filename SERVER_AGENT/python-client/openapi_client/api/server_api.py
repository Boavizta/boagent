...
class ServerApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.server_impact_by_config_v1_server_bottom_up_post_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [],
                'endpoint_path': '/v1/server/bottom-up',
                'operation_id': 'server_impact_by_config_v1_server_bottom_up_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def server_impact_by_config_v1_server_bottom_up_post(
        self,
        **kwargs
    ):
        """Server Impact By Config  # noqa: E501

        LEGACY ROUTE NAME for *Server Impact By Config*   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.server_impact_by_config_v1_server_bottom_up_post(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_content_type'] = kwargs.get(
            '_content_type')
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.server_impact_by_config_v1_server_bottom_up_post_endpoint.call_with_http_info(**kwargs)
